...
class Billmate_Checkout_Model_Methods_Bmcheckout extends Mage_Payment_Model_Method_Abstract
{
    const BM_INVOICE_NUMBER_CODE_PARAM = 'invoiceid';

    const METHOD_CODE = 'bmcheckout';
     ...
     * @var string
     */
    protected $_code = 'bmcheckout';

    /**
     * @var string
     */
    protected $_formBlockType = 'bmcheckout/form';
    ...
    public function capture(Varien_Object $payment, $amount)
    {
        if ($this->isAllowedToProcess()) {
            ...
            if (isset($paymentInfo['PaymentData']['status']) &&
                ...
                if ($amount != $boTotal) {
                    Mage::throwException(Mage::helper('bmconnection')->__('The amounts don\'t match. Billmate Online %s and Store %s. Activate manually in Billmate.',$boTotal,$amount));
                }
