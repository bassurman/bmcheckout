<?php
class Billmate_Checkout_Model_Payment_GatewayCore extends Varien_Object
{
    const METHOD_CODE = 1;
    ...
    protected function getShippingHandData()
    {
        ...
        $invoiceFee = Mage::helper( 'bmcheckout' )->replaceSeparator( $invoiceFee );
        $shippingAddress = $this->getShippingAddress();

        $feeinfo = Mage::helper( 'bmcheckout' )
