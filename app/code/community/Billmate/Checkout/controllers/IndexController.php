...
class Billmate_Checkout_IndexController extends Mage_Core_Controller_Front_Action
{
    /**
     * @var array
     */
    ...
    public function indexAction()
    {
        ...
        if (!$quote->isVirtual() && (!$quote->getShippingAddress()->getCountry()
            ...
            $this->getHelper()->addLog('-------------- assign country ----------');
            $this->getHelper()->addLog($quote->getShippingAddress()->getCountry());
    ...
    public function updateaddressAction()
    {
        ...
        if(!isset($result['code'])) {
            ...
            $respHtml = $this->getLayout()
                ->createBlock('bmcheckout/checkout_cart_shipping', 'checkout.cart.shipping')
    ...
    /**
     * @return Billmate_Checkout_Model_Checkout_Order
     */
    protected function getCheckoutOrderModel()
    {
        return Mage::getModel('bmcheckout/checkout_order');
    }
